...
namespace GymLogIn
{
    public partial class frmGConsulta : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if( Admin.add_consulta(txtNomeConsulta.Text) == 0)
                {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Admin.remove_consulta(Convert.ToInt16(txtIdConsulta.Text)) == 0)
                {
        ...
        private void btnRemoveMarc_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Admin.remove_marcacao(Convert.ToInt16(txtIdMarc.Text)) == 0)
                {
        ...
        {
            if (Admin.add_marcacao(txtIdClienteMarc.Text,txtIdTipoMarc.Text,txtDataMarc.Text) == 0)
            {
