...
namespace GymLogIn
{
    public partial class frmGPagamentoStaff : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if(staff.add_pagamento(txtTipo.Text,txtMontante.Text,txtIdCliente.Text) == 0)
                {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            {
                if (staff.remove_pagamento(txtId.Text) == 0)
                {
