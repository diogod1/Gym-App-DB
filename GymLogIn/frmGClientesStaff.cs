...
namespace GymLogIn
{
    public partial class frmGClientesStaff : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if(staff.adiciona_cliente(txtUsername.Text, txtPassword.Text, txtNome.Text) == 0)
                {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            {
                if (staff.remove_cliente(txtId.Text) == 0)
                {
